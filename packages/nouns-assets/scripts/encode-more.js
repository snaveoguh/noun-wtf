...
var image_data_json_1 = require("../src/image-data.json");
/**
 ...
 */
var encode = function (sourceFolder, destinationFilepath) { return __awaiter(void 0, void 0, void 0, function () {
    var encoder, partfolders, _i, partfolders_1, folder, folderpath, files, _a, files_1, file, image;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                encoder = new sdk_1.PNGCollectionEncoder(image_data_json_1.palette);
            ...
            case 1:
                ...
                folderpath = path_1.default.join(sourceFolder, folder);
            ...
            case 6:
                ...
                return [3 /*break*/, 1];
            case 7:
                if (!(JSON.stringify(encoder.data.palette) !== JSON.stringify(image_data_json_1.palette))) return [3 /*break*/, 10];
                console.log('Palette changed! Aborting');
                return [4 /*yield*/, fs_1.promises.writeFile('original_palette.json', JSON.stringify(image_data_json_1.palette, null, 2))];
            case 8:
                _b.sent();
                return [4 /*yield*/, fs_1.promises.writeFile('new_palette.json', JSON.stringify(encoder.data.palette, null, 2))];
            case 9:
                _b.sent();
                throw new Error("Palette changed, expected to stay the same");
            case 10: return [4 /*yield*/, fs_1.promises.writeFile(destinationFilepath, JSON.stringify({

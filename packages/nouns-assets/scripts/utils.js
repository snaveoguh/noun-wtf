 ...
 */
var readPngImage = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var buffer, png;
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        ...
                        rgbaAt: function (x, y) {
                            ...
                            var _a = [png.data[idx], png.data[idx + 1], png.data[idx + 2], png.data[idx + 3]], r = _a[0], g = _a[1], b = _a[2], a = _a[3];
                            return {
                                r: r,
                                g: g,
                                b: b,

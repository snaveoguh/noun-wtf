...
let _partykitHost = 'noun-wtf-saber.snaveoguh.partykit.dev';
export function setPartykitHost(host: string) {
  _partykitHost = host;
}
export function getPartykitHost(): string {
  return _partykitHost;
}
/** @deprecated Use getPartykitHost() — kept for compat */
export const PARTYKIT_HOST = _partykitHost;

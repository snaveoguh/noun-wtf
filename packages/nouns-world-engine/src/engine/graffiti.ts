...
// ── Graffiti pixel data (platform-agnostic) ─────────────────────────
// Canvas rendering of graffiti is platform-specific.
// The shared engine stores/transmits graffiti as base64 image data.

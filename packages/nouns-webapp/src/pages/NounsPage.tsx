...
const NounsPage: React.FC<NounsPageProps> = () => {
  ...
  // Fetch all seeds for filtering/sorting
  ...
  const {
    ...
    hasActiveFilters,
    filteredAndSorted,
  } = useNounFilters(nounsList, seeds);
  ...
  const totalRows = Math.ceil(displayCount / itemsPerRow);
  ...
  return (
    <div className="mx-auto mt-1 max-w-7xl px-4">
      {/* Filters Bar */}
      <div className="py-4">
        <GalleryFilters
          sortBy={sortBy}
      ...
      <motion.div
        layout
        className="border-border flex h-[600px] overflow-clip rounded-2xl border"
      >
        {/* Explore Container */}

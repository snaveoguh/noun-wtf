          ...
          scene.traverse(child => {
            if (child.name === 'GlassesUV' || child.name.toLowerCase().includes('glasses')) {
              ...
              if (sourceMat?.map) {
                ...
                // material (or worse, disposing its texture) wipes the
                // head's texture too and leaves it rendering flat white.
                // Cloning the material isolates our changes to the glasses
                // mesh; the original keeps the head face textured.

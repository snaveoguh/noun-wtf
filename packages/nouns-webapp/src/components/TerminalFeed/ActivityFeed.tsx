  ...
  return (
    ...
    >
      ...
      {events.length === 0 && !loading && !error && (
        <div style={{ color: '#333', padding: '40px 0', textAlign: 'center', fontSize: '13px' }}>
      ...
      {loading && (
        <div style={{ color: '#00ff41', padding: '12px 0', fontSize: '12px', opacity: 0.6 }}>
          loading...
        </div>
      )}

      {!hasMore && events.length > 0 && (
        <div style={{ color: '#222', padding: '16px 0', fontSize: '11px', textAlign: 'center' }}>
